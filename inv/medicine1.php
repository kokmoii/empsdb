            ...
            <div class="container mt-3">
                <div class="table-responsive">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo '<tr><th scope="col">No</th><th scope="col">Medicine Name</th><th scope="col">Description</th><th scope="col">Quantity</th><th scope="col">Price per unit</th><th scope="col">Exp DAte</th><th scope="col">Supplier Name</th><th scope="col">Status</th><th scope="col">Action</th><th scope="col">Batch</th></tr></thead>';
                        echo '<tbody>';
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<td><a href="batch.php?id=' . $row['medicine_id'] . '" class="btn btn-primary">Batch List</a></td>';
                            echo '</tr>';
                            $rowNumber++;
                        }
