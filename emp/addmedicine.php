...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <a href="medicine.php" class="btn btn-info">Back</a>
        <content>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <h2 class="text-center mb-4">ADD MEDICINE</h2>
                        <form method="post" action="action/addmed.php" onsubmit="return confirm('Are you sure you want to add this medicine?')">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="medicineDesc" name="medicine_desc" required></textarea>
                            </div>
                            <div class="form-group">
